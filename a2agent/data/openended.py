...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dataset_path", default='/nvme/data-pool1/qjl/A2VL_DATA/data/openended/', help="The local path to the raw dataset, if it exists.")
    parser.add_argument(
        "--local_save_dir",
        default="/home/jincai_guo/ICML2025_JIE/QJL/A2AGENT/a2agent/data/openended",
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            ...
            cleaned_problem = SYSTEM_PROMPT_2 + problem.replace(remove_text, "\n").strip()
            data = {
                "messages": [
                    {
                        "role": "system",
