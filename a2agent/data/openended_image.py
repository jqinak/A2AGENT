...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dataset_path", default='/nvme/data-pool1/qjl/A2VL_DATA/data/openendedimage', help="The local path to the raw dataset, if it exists.")
    parser.add_argument(
        "--local_save_dir",
        default="/home/jincai_guo/ICML2025_JIE/QJL/A2AGENT/a2agent/data/openendedimage",
